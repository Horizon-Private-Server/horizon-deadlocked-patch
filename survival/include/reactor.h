...
#define REACTOR_BASE_ATTACK_COOLDOWN_TICKS			(5 * TPS)
...
#define REACTOR_MAX_DIST_FOR_CHARGE		          (20)

#define REACTOR_CHARGE_ATTACK_COOLDOWN_TICKS    (TPS * 60)
#define REACTOR_LASER_ATTACK_COOLDOWN_TICKS     (TPS * 60 * 2)
...
#define REACTOR_BASE_COLL_RADIUS								(0.5)
...
enum ReactorAnimId
{
	...
	REACTOR_ANIM_FIRING_FROM_CHEST,
