...
{
  MOB_TARGET_NEAREST = 0x00,
  MOB_TARGET_STRONGEST = 0x01,
  MOB_TARGET_WEAKEST = 0x02,
  MOB_TARGET_ANY = 0x00,
  MOB_TARGET_PLAYER = 0x10,
  MOB_TARGET_OTHER = 0x20,

  MOB_TARGET_MASK_STRATEGY = 0x0f,
  MOB_TARGET_MASK_TARGET = 0xf0,

  // ANY
  MOB_TARGET_NEAREST_ANY = (MOB_TARGET_ANY | MOB_TARGET_NEAREST),
  MOB_TARGET_STRONGEST_ANY = (MOB_TARGET_ANY | MOB_TARGET_STRONGEST),
  MOB_TARGET_WEAKEST_ANY = (MOB_TARGET_ANY | MOB_TARGET_WEAKEST),

  // PLAYER
  MOB_TARGET_NEAREST_PLAYER = (MOB_TARGET_PLAYER | MOB_TARGET_NEAREST),
  MOB_TARGET_STRONGEST_PLAYER = (MOB_TARGET_PLAYER | MOB_TARGET_STRONGEST),
  MOB_TARGET_WEAKEST_PLAYER = (MOB_TARGET_PLAYER | MOB_TARGET_WEAKEST),

  // OTHER
  MOB_TARGET_NEAREST_OTHER = (MOB_TARGET_OTHER | MOB_TARGET_NEAREST),
  MOB_TARGET_STRONGEST_OTHER = (MOB_TARGET_OTHER | MOB_TARGET_STRONGEST),
  MOB_TARGET_WEAKEST_OTHER = (MOB_TARGET_OTHER | MOB_TARGET_WEAKEST),
};
